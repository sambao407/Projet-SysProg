    ...
    public class KerimLauncher
    {
        ...
        /*public static void Main()
        {
           ...
           // Model.Cuisinier CuisinierOrlando = new Model.Cuisinier(1, "Orlando", true, null);
            ...
            //Model.Recette Hamburger = new Model.Recette(1, "Hamburger", "Pain Hmburger", "Steack Haché", "Salade", "Tomate", 5);
          ...
          //  Model.Recette TEST = new Model.Recette(1, "Hamburger", "R", "Steack Haché", "Salade", "Patate", 5);
            
          //  Model.Commande Commande1 = new Model.Commande(1, 0, TEST);
